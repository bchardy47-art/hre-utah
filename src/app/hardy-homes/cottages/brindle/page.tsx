...
export default function BrindlePage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <div id="brindle" className="hardy-detail-hero">
            ...
            <div className="hardy-compact-spec-grid hardy-compact-spec-grid--three" aria-label="The Brindle specifications">
              ...
              <div className="card hardy-mini-spec-card"><span className="label">BEDROOMS</span><strong>2</strong></div>
              <div className="card hardy-mini-spec-card"><span className="label">BATHROOMS</span><strong>2.5</strong></div>
            </div>
          </div>
      ...
      <section className="section alt" aria-labelledby="brindle-gallery">
        <div className="container">
          <div className="sec-head hardy-section-head-compact">
            <span className="eyebrow">Gallery</span>
            <h2 id="brindle-gallery">See The Brindle at a glance.</h2>
          </div>
          <div className="hardy-detail-gallery hardy-detail-gallery--brindle-twoup">
            {[exterior, kitchen, layout].map((image) => (
              <article key={image.key} className="card hardy-detail-media-card">
                <div className={`hardy-gallery-media ${image.key === "exterior" ? "hardy-gallery-media-exterior" : image.key === "layout" ? "hardy-gallery-media-dollhouse" : "hardy-gallery-media-tall"}`}>
                  <Image
                    src={image.src}
                    alt={image.alt}
                    fill
      ...
      <section className="section" aria-labelledby="brindle-highlights">
        <div className="container">
          <div className="hardy-detail-grid hardy-detail-grid--compact">
            <article className="card hardy-highlights-card">
              ...
              <h2 id="brindle-highlights">What matters most in The Brindle</h2>
      ...
      <section className="section alt" aria-labelledby="brindle-cta">
        <div className="container">
          <div className="card hardy-catalog-cta plan-accent">
            <div>
              <span className="eyebrow">Interested in The Brindle?</span>
              <h2 id="brindle-cta">Tell us about your property and what you want to build.</h2>
            </div>
